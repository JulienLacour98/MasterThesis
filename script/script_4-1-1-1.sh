...
#BSUB -q hpc
### -- set the job Name --
#BSUB -J Script_4-1-1-1
### -- ask for number of cores (default: 1) --
#BSUB -n 20
### -- specify that the cores must be on the same host --
#BSUB -R "span[hosts=1]"
### -- specify that we need 100MB of memory per core/slot --
#BSUB -R "rusage[mem=100MB]"
### -- specify that we want the job to get killed if it exceeds 100 MB per core/slot --
#BSUB -M 100MB
...
#BSUB -o results/Script_4-1-1-1_%J.csv
#BSUB -e results/Error_4-1-1-1_%J.err
...
python3 Main.py 4 1 0 "cnf/uf/uf20-91/uf20-91-9" 1000 1000000 20